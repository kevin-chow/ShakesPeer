...
export const allCharacters = [
  ...
  { id: "Moth",         type: 'fairy', total: 3,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 3,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Peaseblossom", type: 'fairy', total: 5,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 4,   a3s2: 0,   a4s1: 1,   a4s2: 0,   a5s1: 0   },
  ...
  { id: "Cobweb",       type: 'fairy', total: 5,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 4,   a3s2: 0,   a4s1: 1,   a4s2: 0,   a5s1: 0   },
  ...
  { id: "Mustardseed",  type: 'fairy', total: 8,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 4,   a3s2: 0,   a4s1: 4,   a4s2: 0,   a5s1: 0   },
...
export const allOutwardSentiments = [
  { id: "Hermia",       type: 'lover', total: -4,   a1s1: 5, a1s2: 0,   a2s1: 0,   a2s2: 8, a3s1: 0,   a3s2: -17, a4s1: 0,  a4s2: 0,   a5s1: 0   },
  { id: "Moth",         type: 'fairy', total: 1,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 1,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Peaseblossom", type: 'fairy', total: 3,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 2,   a3s2: 0,   a4s1: 1,   a4s2: 0,   a5s1: 0   },
  { id: "Titania",      type: 'fairy', total: 23, a1s1: 0,   a1s2: 0,   a2s1: -14, a2s2: 0,  a3s1: 25, a3s2: 0,   a4s1: 10, a4s2: 0,   a5s1: 2  },
  { id: "Demetrius",    type: 'lover', total: 24, a1s1: 3,  a1s2: 0,   a2s1: 6, a2s2: -1,  a3s1: 0,   a3s2: 3, a4s1: 9, a4s2: 0,   a5s1: 4 },
  { id: "Hippolyta",    type: 'other', total: 7,  a1s1: 1,  a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 1,  a4s2: 0,   a5s1: 5 },
  { id: "Second Fairy", type: 'fairy', total: -1,   a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: -1,  a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Quince",       type: 'actor', total: -25,  a1s1: 0,   a1s2: -6, a2s1: 0,   a2s2: 0,   a3s1: 11, a3s2: 0,   a4s1: 0,   a4s2: 5,  a5s1: -35 },
  { id: "Lysander",     type: 'lover', total: 18, a1s1: 14, a1s2: 0,   a2s1: 0,   a2s2: 5, a3s1: 0,   a3s2: -4, a4s1: 0,  a4s2: 0,   a5s1: 3 },
  { id: "Helena",       type: 'lover', total: -14, a1s1: 11, a1s2: 0,   a2s1: -2, a2s2: -1, a3s1: 0,   a3s2: -25, a4s1: 3,  a4s2: 0,   a5s1: 0   },
  { id: "Puck",         type: 'fairy', total: -8, a1s1: 0,   a1s2: 0,   a2s1: -8, a2s2: 1, a3s1: 6,  a3s2: -6, a4s1: -1,  a4s2: 0,   a5s1: 0 },
  { id: "First Fairy",  type: 'fairy', total: 0,   a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,  a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Theseus",      type: 'other', total: 30, a1s1: 0, a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 7, a4s2: 0,   a5s1: 23 },
  { id: "Cobweb",       type: 'fairy', total: 2,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 1,   a3s2: 0,   a4s1: 1,   a4s2: 0,   a5s1: 0   },
  { id: "Egeus",        type: 'other', total: 10,  a1s1: 7, a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 3,  a4s2: 0,   a5s1: 0   },
  { id: "Snout",        type: 'actor', total: -1,  a1s1: 0,   a1s2: -1,   a2s1: 0,   a2s2: 0,   a3s1: 0,  a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0 },
  { id: "Oberon",       type: 'fairy', total: 10, a1s1: 0,   a1s2: 0,   a2s1: 6, a2s2: 7,  a3s1: 0,   a3s2: -2, a4s1: 6, a4s2: 0,   a5s1: -5 },
  { id: "Starveling",   type: 'actor', total: -3,   a1s1: 0,   a1s2: -1,   a2s1: 0,   a2s2: 0,   a3s1: -1,  a3s2: 0,   a4s1: 0,   a4s2: -1,  a5s1: 0  },
  { id: "Flute",        type: 'actor', total: 1,  a1s1: 0,   a1s2: 0,  a2s1: 0,   a2s2: 0,   a3s1: 0,  a3s2: 0,   a4s1: 0,   a4s2: 1,  a5s1: 0 },
  { id: "Philostrate",  type: 'other', total: 1,  a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 1 },
  { id: "Mustardseed",  type: 'fairy', total: 2,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 1,   a3s2: 0,   a4s1: 1,   a4s2: 0,   a5s1: 0   },
  { id: "Bottom",       type: 'actor', total: 15, a1s1: 0,   a1s2: -10, a2s1: 0,   a2s2: 0,   a3s1: 1, a3s2: 0,   a4s1: 9, a4s2: 15, a5s1: 0 },
  { id: "Snug",         type: 'actor', total: 2,  a1s1: 0,   a1s2: -2,  a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 4,  a5s1: 0 },
  { id: "Fairy",        type: 'fairy', total: -1,  a1s1: 0,   a1s2: 0,   a2s1: -1, a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   }
];

export const allInwardSentiments = [
  { id: "Hermia",       type: 'lover', total: 22,   a1s1: 15, a1s2: 0,   a2s1: 0,   a2s2: 5, a3s1: 0,   a3s2: -2, a4s1: 6,  a4s2: 0,   a5s1: -2  },
  { id: "Moth",         type: 'fairy', total: 3,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 3,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Peaseblossom", type: 'fairy', total: 5,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 6,   a3s2: 0,   a4s1: -1,   a4s2: 0,   a5s1: 0   },
  { id: "Titania",      type: 'fairy', total: 12, a1s1: 0,   a1s2: 0,   a2s1: 1, a2s2: 0,  a3s1: 3, a3s2: 0,   a4s1: 8, a4s2: 0,   a5s1: 0  },
  { id: "Demetrius",    type: 'lover', total: -35, a1s1: 0,  a1s2: 0,   a2s1: -2, a2s2: -1,  a3s1: 0,   a3s2: -34, a4s1: 1, a4s2: 0,   a5s1: 1 },
  { id: "Hippolyta",    type: 'other', total: 3,  a1s1: 7,  a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 1,  a4s2: 0,   a5s1: -5 },
  { id: "Second Fairy", type: 'fairy', total: 0,   a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,  a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Quince",       type: 'actor', total: 5,  a1s1: 0,   a1s2: -2, a2s1: 0,   a2s2: 0,   a3s1: 2, a3s2: 0,   a4s1: 0,   a4s2: 5,  a5s1: 0 },
  { id: "Lysander",     type: 'lover', total: 4, a1s1: 6, a1s2: 0,   a2s1: 0,   a2s2: 9, a3s1: 0,   a3s2: -13, a4s1: 1,  a4s2: 0,   a5s1: 1 },
  { id: "Helena",       type: 'lover', total: 18, a1s1: 3, a1s2: 0,   a2s1: 6, a2s2: -1, a3s1: 0,   a3s2: 7, a4s1: 5,  a4s2: 0,   a5s1: -2   },
  { id: "Puck",         type: 'fairy', total: 6, a1s1: 0,   a1s2: 0,   a2s1: 4, a2s2: 0, a3s1: 0,  a3s2: -2, a4s1: 4,  a4s2: 0,   a5s1: 0 },
  { id: "First Fairy",  type: 'fairy', total: -1,   a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: -1,  a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Theseus",      type: 'other', total: 22, a1s1: 11, a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 9, a4s2: 0,   a5s1: 2 },
  { id: "Cobweb",       type: 'fairy', total: 5,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 5,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   },
  { id: "Egeus",        type: 'other', total: 0,  a1s1: 0, a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 2,  a4s2: 0,   a5s1: 0   },
  { id: "Snout",        type: 'actor', total: 0,  a1s1: 0,   a1s2: -4,   a2s1: 0,   a2s2: 0,   a3s1: 0,  a3s2: 0,   a4s1: 0,   a4s2: 4,   a5s1: 0 },
  { id: "Oberon",       type: 'fairy', total: -21, a1s1: 0,   a1s2: 0,   a2s1: -15, a2s2: 0,  a3s1: 0,   a3s2: -7, a4s1: -1, a4s2: 0,   a5s1: 2 },
  { id: "Starveling",   type: 'actor', total: 4,   a1s1: 0,   a1s2: -4,   a2s1: 0,   a2s2: 0,   a3s1: 1,  a3s2: 0,   a4s1: 0,   a4s2: 4,  a5s1: 3  },
  { id: "Flute",        type: 'actor', total: 5,  a1s1: 0,   a1s2: -3,  a2s1: 0,   a2s2: 0,   a3s1: 2,  a3s2: 0,   a4s1: 0,   a4s2: 6,  a5s1: 0 },
  { id: "Philostrate",  type: 'other', total: -2,  a1s1: -1,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: -1 },
  { id: "Mustardseed",  type: 'fairy', total: 11,    a1s1: 0,   a1s2: 0,   a2s1: 0,   a2s2: 0,   a3s1: 7,   a3s2: 0,   a4s1: 4,   a4s2: 0,   a5s1: 0   },
  { id: "Bottom",       type: 'actor', total: 30, a1s1: 0,   a1s2: -3, a2s1: 0,   a2s2: 0,   a3s1: 15, a3s2: 0,   a4s1: 13, a4s2: 3, a5s1: 2 },
  { id: "Snug",         type: 'actor', total: 3,  a1s1: 0,   a1s2: -4,  a2s1: 0,   a2s2: 0,   a3s1: 3,   a3s2: 0,   a4s1: 0,   a4s2: 2,  a5s1: 2  },
  { id: "Fairy",        type: 'fairy', total: -7,  a1s1: 0,   a1s2: 0,   a2s1: -7, a2s2: 0,   a3s1: 0,   a3s2: 0,   a4s1: 0,   a4s2: 0,   a5s1: 0   }
];
